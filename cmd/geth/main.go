...
import (
	...
	"github.com/VMETA3/vmeta3-l2geth/internal/debug"
...
var (
	...
	// UsingOVM
	// Vmeta3 specific flags must be added to the application
	// flag parsing logic
	vmeta3Flags = []cli.Flag{
...
func init() {
	...
	// UsingOVM
	app.Flags = append(app.Flags, vmeta3Flags...)
